...
module Geomora
  module Core
    class ScaleEstimator
      ...
      def self.from_detection(elements, image_width:, image_height:)
        ...
        wall_length = estimate_wall_length(elements, wall_height, image_width, image_height)
      ...
      def self.estimate_wall_length(elements, wall_height, image_width, image_height)
