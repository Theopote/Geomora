...
require File.join(PLUGIN, 'core/scale_estimator')
...
require File.join(PLUGIN, 'core/project')
require File.join(PLUGIN, 'core/yolo_label_exporter')
...
require File.join(PLUGIN, 'core/h264_bitstream')
require File.join(PLUGIN, 'core/h264_frame_encoder')
require File.join(PLUGIN, 'core/h264_cavlc')
require File.join(PLUGIN, 'core/h264_mp4_encoder')
